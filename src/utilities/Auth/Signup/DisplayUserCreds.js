...
function DisplayUserCreds({userProfile,onSubmit}){
  const handleSubmit = (values,key) => {
    ...
    return (
        <>
          <Descriptions  bordered layout="vertical" items={[
        {
            key: '1',
            label: 'Email',
            children: 
            <Formik
            initialValues={{ email: userProfile.email }}
         ...
         <div className="form-field">
          ...
          <Descriptions  bordered layout='vertical' items={[
            ...
            <>
                ...
                } defaultChecked={darkMode} onChange={toggleDarkMode} />        
            </>
          },
          ]} />
        </>
...
export default DisplayUserCreds;